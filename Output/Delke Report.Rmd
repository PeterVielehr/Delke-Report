...
In general, two noticeable findings emerge. First, Officer Delke was above the mean in nine out of 10 zones. Zones highlighted in red show areas where he differed by a large about from his peers. Zones with small sample sizes should be interpreted cautiously because percentages can change widely based on a few cases.
