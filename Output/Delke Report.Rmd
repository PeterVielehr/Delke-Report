...
knitr::kable(t, col.names = tnames, booktabs = T,
  ...
  kable_styling(latex_options = c("striped",  "repeat_header", position = "float_right"),
                full_width = F) %>%
...
p<-ggplot(data=df, aes(x=names, y=rate, fill=group)) +
  ...
  ggtitle("Figure 3: Percent of Drivers Searched\nOfficers Making More than 100 Stops Over 2-year Period", 
          subtitle = "Median Officer Percentage Compared to Officer Delke, (N=666)") +
